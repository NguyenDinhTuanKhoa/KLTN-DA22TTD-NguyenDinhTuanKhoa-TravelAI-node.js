                ...
                return (
                  ...
                  >
                    ...
                    <Link href={`/itinerary/${itin._id}`} className="flex-1 p-5 md:p-6 flex flex-col relative z-10">
                      ...
                      {/* Meta & Title */}
                      <div className="mb-4">
                        <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[11px] font-bold uppercase tracking-wider mb-3 border ${status.bg} ${status.color}`}>
